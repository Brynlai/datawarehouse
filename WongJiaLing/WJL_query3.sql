...
TTITLE CENTER 'Room Category Performance Trend Analysis (ADR, RevPAR)' SKIP 1 -
       CENTER 'Analysis Period: 2020 - 2024' SKIP 2 -
...
COLUMN "Occupancy_Rate"            FORMAT 990.0         HEADING 'Room Occupancy (%)'
COLUMN "ADR"                       FORMAT 99,990.00     HEADING 'Average Daily Rate|(RM)'
COLUMN "RevPAR"                    FORMAT 99,990.00     HEADING 'Revenue per Available | Room (RM)'
COLUMN "Strategic_Insight"         FORMAT A38           HEADING 'Strategic Insight'
...
SELECT
  ...
  pm.OccupancyRate AS "Occupancy_Rate",
  pm.ADR AS "ADR",
  pm.RevPAR AS "RevPAR",
  CASE
